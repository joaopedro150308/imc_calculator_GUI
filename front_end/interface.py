...
def iniciar_interface():
    ...
    layout = [
        ...
        [sg.Text('Altura(m)', size=(10, 1)),
         sg.Input(key='altura', size=(8, 1))],
    ...
    # Janela
    window = sg.Window('Calcular IMC', layout=layout,
                       finalize=True, size=(250, 150))
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED or event == 'Sair':
            ...
            try:
                ...
                # Calculando imc
                from back_end.imc import calcular_imc
                imc = calcular_imc(peso, altura)

                # Encontrando a categoria de acordo com aquele IMC
                from back_end.categorias import encontrar_categoria
                ...
                window['categoria'].update(
                    visible=True, value=categoria.estado, text_color=categoria.text_color)

            except ValueError:
                sg.popup_ok(
                    'Oops, Valor inválildo. Por favor tente inserir um valor válido', title='Erro, valor inválido')
